package cn.mastercom.app.gb28181.transmit.cmd.impl;
...
import cn.mastercom.app.gb28181.session.VideoStreamSessionManager;
import cn.mastercom.app.gb28181.transmit.cmd.ISIPCommander;
import cn.mastercom.app.gb28181.transmit.cmd.SIPRequestHeaderProvider;
import cn.mastercom.app.gb28181.utils.DateUtil;
...
public class SIPCommander implements ISIPCommander {
    ...
    */
	 ...
	 */  
	@Override
	public String playStreamCmd(Device device, String deviceId, String channelId) {
		try {
			...
			/*content.append("o=" + channelId +" 0 0 IN IP4  192.168.1.117 \r\n");*/
	        ...
	        //Request request = headerProvider.createInviteRequest(device, channelId, content.toString(),  "live");
			Request request = headerProvider.createInviteRequest(device, channelId, content.toString(),  deviceId);
	...
	public String playbackStreamCmd(Device device, String channelId, String startTime, String endTime) {
		try {
			...
			Request request = headerProvider.createInviteRequest(device, channelId, content.toString(),  null);
